...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Phone Store</a> - All rights reserved © 2024 - Designed by
            <span style="color: #eee; font-weight: bold">group 3 thku</span></p>
    </div>`);
}
        ...
        <section>
            <ul class="flexContain">
                ...
                <li>Hỗ trợ suốt thời gian sử dụng.
                    <br>Hotline:
                    <a href="tel:0912345678" style="color: #288ad6;">0912345678</a>
                </li>
            </ul>
        </section>
    </div>`);
